  ...
  theme: {
    extend: {
      tokens: {
        ...
        shadows: {
          card:          { value: "0 1px 4px rgba(0,0,0,0.10), 0 4px 16px rgba(0,0,0,0.06)" },
          cardHover:     { value: "0 2px 8px rgba(0,0,0,0.14), 0 6px 20px rgba(0,0,0,0.08)" },
          header:        { value: "0 1px 6px rgba(0,0,0,0.10)" },
          panel:         { value: "0 4px 16px rgba(0,0,0,0.12), 0 1px 4px rgba(0,0,0,0.08)" },
          dropdown:      { value: "0 4px 24px rgba(0,0,0,0.14), 0 1px 6px rgba(0,0,0,0.08)" },
          modal:         { value: "0 2px 8px rgba(0,0,0,0.12), 0 8px 32px rgba(0,0,0,0.08)" },
          ...
          buttonDefault: { value: "0 1px 2px rgba(60,64,67,0.3), 0 1px 3px rgba(60,64,67,0.15)" },
          buttonHover:   { value: "0 1px 3px rgba(60,64,67,0.3), 0 2px 6px rgba(60,64,67,0.15)" },
        },
